...
import com.mycorp.config.DatatsourceMySQLConfig;
...
public class GenericWriter implements ItemWriter<String> {
	...
	public void write(List<? extends String> messages) throws Exception {
		...
		for (String msg : messages) {
			...
			System.out.println(String.format("Thread %d: writer %s: insert string: %s", threadId, this.toString(), insert_string));
